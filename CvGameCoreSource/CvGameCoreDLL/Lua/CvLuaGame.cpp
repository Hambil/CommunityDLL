...
int CvLuaGame::lCityPurchaseUnit(lua_State* L)
{
	...
	GetInstance()->CityPurchase(pkCity, eUnitType, NO_BUILDING, NO_PROJECT);
	return 0;
}
//------------------------------------------------------------------------------
// void cityPurchase(CyCity* pCity, UnitTypes eUnitType, BuildingTypes eBuildingType, ProjectTypes eProjectTypes);
int CvLuaGame::lCityPurchaseBuilding(lua_State* L)
{
	...
	GetInstance()->CityPurchase(pkCity, NO_UNIT, eBuildingType, NO_PROJECT);
	return 0;
}
//------------------------------------------------------------------------------
// void cityPurchase(CyCity* pCity, UnitTypes eUnitType, BuildingTypes eBuildingType, ProjectTypes eProjectTypes);
int CvLuaGame::lCityPurchaseProject(lua_State* L)
{
	...
	GetInstance()->CityPurchase(pkCity, NO_UNIT, NO_BUILDING, eProjectType);
	return 0;
}
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
//void DoMinorGoldGift(int iGold);
